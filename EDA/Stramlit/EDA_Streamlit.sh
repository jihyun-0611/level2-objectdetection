...
inference_path='/home/ksy/Documents/naver_ai_tech/LV2/level2-objectdetection-cv-23/src/inference_json/efficientdet.json' # 본인의 inference json 파일 경로를 입력하세요.
...
streamlit run EDA_Streamlit.py -- --dataset_path "$dataset_path" --font_path "$font_path" --inference_path "$inference_path" --validation_path "$validation_path"